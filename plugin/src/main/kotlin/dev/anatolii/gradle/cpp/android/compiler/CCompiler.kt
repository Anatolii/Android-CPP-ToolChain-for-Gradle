...
internal class CCompiler(
...
) : AndroidCompatibleNativeCompiler<CCompileSpec>(
        buildOperationExecutor,
        compilerOutputFileNamingSchemeFactory,
        commandLineToolInvocationWorker,
        invocationContext,
        CCompileArgsTransformer(cppLibraryAndroid),
    ...
    private class CCompileArgsTransformer(cppLibraryAndroid: CppLibraryAndroid)
        : GccCompilerArgsTransformer<CCompileSpec>(cppLibraryAndroid, "c")
}
